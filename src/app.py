...
def welcome():
    return {
        'msg': 'Hello World! This is a simple Python app using Flask! With an ECS Blue-Green-Deployment using Amazon CodeDeploy! <br> Use the endpoints to access other pages.',
